...
export default function Home() {
  ...
  const fetchAssignments = async () => {
    try {
      setLoading(true);
      console.log("Fetching assignments from:", BASE_URL);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // For now, let's try without file upload to test basic CRUD
      ...
      if (isEditing && editingId) {
        ...
        console.log("Updating assignment:", editingId);
        const res = await axios.put(`${BASE_URL}/${editingId}`, submissionData);
  ...
  const markReviewed = async (id: string) => {
    console.log("Mark as reviewed clicked for ID:", id);
    try {
      console.log("Updating status to reviewed for:", id);
      const res = await axios.put(`${BASE_URL}/${id}`, { status: "Reviewed" });
      console.log("Mark reviewed response:", res.data);
            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-2xl border border-white/30 shadow-2xl p-8 mb-8 animate-fadeInUp animate-stagger-1">
                  ...
                  >
                    ...
                    {form.file ? (
                      ...
                      <div className="text-center">
                        <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg shadow-blue-500/30">
                        ...
                        <button
                          ...
                          className="px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-xl hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-200"
                        >
                          Browse Files
                        </button>
                      </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  disabled={submitting}
                  className="px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-bold rounded-xl hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-lg"
                >
              ...
              {loading ? (
                ...
                <div className="space-y-4">
                  ...
                  {assignments.map((assignment, index) => {
                    console.log("Rendering assignment:", assignment, "Index:", index);
                    return (
                    <div
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-white/80 text-sm">
                            <div className="flex items-center gap-2">
                              ...
                              {assignment.studentName || 'No Student'}
                            </div>
                            <div className="flex items-center gap-2">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                      ...
                      {(assignment.fileUrl || assignment.fileName) && (
                        <div className="mb-4">
                          <p className="text-blue-300 text-sm">
                            {assignment.fileName || 'File attached'}
                          </p>
                        </div>
                      )}
